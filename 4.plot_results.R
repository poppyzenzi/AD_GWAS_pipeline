...
## Plot Manhattan with the filtered data
for (ancestry in ancestry_list) {

  sumstats <- read.table(paste0("filtered_alspac_P_adoldep_", ancestry, ".regenie"), header = TRUE)
...
## Plot QQ with the unfiltered data
